...
result = structured_model.invoke("""
    The hardware is great but the software feels bloated. There are too many unnecessary features that slow down the device. Overall, I would say it's a decent product but could be improved significantly with a software update.
""")

print(f"Type of result: {type(result)}") # This is  return a dictionary according to the TypedDict defined above
