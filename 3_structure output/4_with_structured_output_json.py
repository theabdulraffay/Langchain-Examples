...
structured_model_with_json = model.with_structured_output(json_schema)
result_with_json = structured_model_with_json.invoke("""
...
# result_with_json = result_with_json.model_dump()  # Convert Pydantic model to dictionary


print(f"Type of result: {type(result_with_json)}") # This is  return a dictionary according to the TypedDict defined above
print(f"Key Themes: {result_with_json['key_themes']}")
print(f"Summary: {result_with_json['summary']}")
print(f"Sentiment: {result_with_json['sentiment']}")
print(f"Pros: {result_with_json['pros']}")
print(f"Cons: {result_with_json['cons']}")
